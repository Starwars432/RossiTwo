    ...
    <div className="min-h-screen bg-black text-white relative font-serif overflow-x-hidden">
      ...
      <nav className="fixed w-full z-50 px-6 py-4 bg-transparent">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-8">
            <Link to="home" smooth={true} duration={500} className="text-sm hover:text-blue-400 transition-colors">
              Home
            </Link>
            <Link to="services" smooth={true} duration={500} className="text-sm hover:text-blue-400 transition-colors">
              Services
            </Link>
            <Link to="portfolio" smooth={true} duration={500} className="text-sm hover:text-blue-400 transition-colors">
              Portfolio
            </Link>
            <Link to="custom-design" smooth={true} duration={500} className="text-sm hover:text-blue-400 transition-colors">
              Custom Design
            </Link>
            <Link to="contact" smooth={true} duration={500} className="text-sm hover:text-blue-400 transition-colors">
              Contact
            </Link>
      ...
      <section id="contact" className="relative py-20 px-6 bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400">Have questions or ready to start your project? Reach out to us and we'll get back to you as soon as possible.</p>
          </motion.div>
      ...
      <footer className="bg-black/50 backdrop-blur-lg py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Product Ad Design</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Brand Identity</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Clothing Design</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">AI Model Generation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Digital Marketing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Custom Design Solutions</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="home" smooth={true} duration={500} className="text-gray-400 hover:text-blue-400 transition-colors cursor-pointer">Home</Link></li>
              <li><Link to="services" smooth={true} duration={500} className="text-gray-400 hover:text-blue-400 transition-colors cursor-pointer">Services</Link></li>
              <li><Link to="portfolio" smooth={true} duration={500} className="text-gray-400 hover:text-blue-400 transition-colors cursor-pointer">Portfolio</Link></li>
              <li><Link to="custom-design" smooth={true} duration={500} className="text-gray-400 hover:text-blue-400 transition-colors cursor-pointer">Custom Design</Link></li>
              <li><Link to="contact" smooth={true} duration={500} className="text-gray-400 hover:text-blue-400 transition-colors cursor-pointer">Contact</Link></li>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-500">© 2025 Manifest Illusions. All rights reserved.</p>
        </div>
      </footer>
