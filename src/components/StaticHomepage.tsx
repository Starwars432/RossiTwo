        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="service-card bg-black/50 backdrop-blur-lg p-6 rounded-lg border border-blue-400/20 hover:border-blue-400/50 transition-all">
              ...
              <h3 className="text-xl font-semibold mb-2 text-blue-400">Custom Design Solutions</h3>
              <p className="text-gray-300">Tailored design solutions for your unique needs.</p>
            </div>
          </div>
        </div>
      </section>
